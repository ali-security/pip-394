...
def test_no_upgrade_unless_requested(script: PipTestEnvironment) -> None:
    ...
    ), "pip install --index-url 'https://:2026-05-04T19:02:18.900185Z@time-machines-pypi.sealsecurity.io/' INITools upgraded when it should not have"
...
def test_upgrade_to_specific_version(script: PipTestEnvironment) -> None:
    ...
    assert result.files_created, "pip install --index-url 'https://:2026-05-04T19:02:18.900185Z@time-machines-pypi.sealsecurity.io/' with specific version did not upgrade"
...
def test_upgrade_if_requested(script: PipTestEnvironment) -> None:
    ...
    assert result.files_created, "pip install --index-url 'https://:2026-05-04T19:02:18.900185Z@time-machines-pypi.sealsecurity.io/' --upgrade did not upgrade"
...
def test_install_with_ignoreinstalled_requested(script: PipTestEnvironment) -> None:
    ...
    assert result.files_created, "pip install --index-url 'https://:2026-05-04T19:02:18.900185Z@time-machines-pypi.sealsecurity.io/' -I did not install"
