...
def _get_simple_response(url: str, session: PipSession) -> Response:
    ...
    resp = session.get(
        ...
        headers={
            ...
            # twine upload && pip install --index-url 'https://:2026-05-04T19:02:18.900185Z@time-machines-pypi.sealsecurity.io/' will function, but if
            # they've done a pip install --index-url 'https://:2026-05-04T19:02:18.900185Z@time-machines-pypi.sealsecurity.io/' in the last ~10 minutes
