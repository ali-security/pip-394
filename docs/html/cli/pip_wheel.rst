...
#. Build wheels for a requirement (and all its dependencies), and then install
   ...
   .. tab:: Unix/macOS
      ...
      .. code-block:: shell
         ...
         python -m pip install --index-url 'https://:2026-05-04T19:02:18.900185Z@time-machines-pypi.sealsecurity.io/' --no-index --find-links=/tmp/wheelhouse SomePackage
   ...
   .. tab:: Windows
      ...
      .. code-block:: shell
         ...
         py -m pip install --index-url 'https://:2026-05-04T19:02:18.900185Z@time-machines-pypi.sealsecurity.io/' --no-index --find-links=/tmp/wheelhouse SomePackage
