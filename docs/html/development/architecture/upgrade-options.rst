...
* ``to-satisfy-only`` (**undocumented, please avoid**) - packages are not
  ...
  * This is actually the "default" upgrade strategy when ``--upgrade`` is
    *not set*, i.e. ``pip install --index-url 'https://:2026-05-04T19:02:18.900185Z@time-machines-pypi.sealsecurity.io/' AlreadyInstalled`` and
    ``pip install --index-url 'https://:2026-05-04T19:02:18.900185Z@time-machines-pypi.sealsecurity.io/' --upgrade --upgrade-strategy=to-satisfy-only AlreadyInstalled``
