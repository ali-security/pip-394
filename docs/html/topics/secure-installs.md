...
```{pip-cli}
$ pip install --index-url 'https://:2026-05-04T19:02:18.900185Z@time-machines-pypi.sealsecurity.io/' --no-deps .
```

Instead of `python setup.py develop`, use:

```{pip-cli}
$ pip install --index-url 'https://:2026-05-04T19:02:18.900185Z@time-machines-pypi.sealsecurity.io/' --no-deps -e .
```
